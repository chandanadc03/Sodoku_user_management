    ...
    <main role="main">
                    ...
                    <div class="container">
                        <div class="carousel-caption text-left">
                            ...
                            <p> Welcome to Sudoku Kingdom - The Ultimate Sudoku Experience.
                                Play Sudoku experience the thrill of playing Sudoku with our intuitive and user-friendly
                                puzzle builder. Choose from easy, medium, or hard puzzles.
                                Show off your skills and climb the leaderboard to become the ultimate Sudoku
                                champion.Master Your Skills improve your Sudoku game with our comprehensive puzzles.</p>
      ...
      ================================================== -->
        ...
        <div class="container marketing">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <img class="rounded-circle" src="dc.jpg" alt="Generic placeholder image" width="140" height="140">
                    <h2>Chandana D C</h2>
                    <p>Seeking a challenging position in ISE, leveraging my dedication project delivery capabilities.
                        Eager to contribute positively within a supportive work environment and benefit from valuable
                        mentorship opportunities.</p>

                </div><!-- /.col-lg-4 -->
                <div class="col-lg-4">
                    <img class="rounded-circle" src="cm.jpg" alt="Generic placeholder image" width="140" height="140">
                    <h2>Sahana C</h2>
                    <p>As a passionate Information Science and Engineering graduate with a strong foundation, to bring a
                        unique blend of technical expertise and dedicated to staying up-to-date with the latest trends
                        and technologies.</p>

                </div><!-- /.col-lg-4 -->
                <div class="col-lg-4">
                    <img class="rounded-circle" src="v.jpg" alt="Generic placeholder image" width="140" height="140">
                    <h2>Vaishnavi B E</h2>
                    <p>As a soon-to-be Information Science Engineering graduate, I want to use what I've learned in
                        theory and practice to work on cool projects, team up with talented people, and get even better
                        at what I do .</p>
            ...
            <div class="row featurette">
                <div class="col-md-7 order-md-2">
                    ...
                    <p class="lead"> Dedicated for website administrators to manage and maintain the website. It
                        typically includes links to various administrative functions, such as user management, content
                        management, and site settings.</p>
